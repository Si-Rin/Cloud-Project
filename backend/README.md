...
To help validate **CloudWatch CPU alarms**, a new endpoint was added:

- `GET /stress`

### Why this was added

The endpoint is intentionally CPU-intensive so you can generate load on demand and confirm that your CloudWatch alarm thresholds and notifications are correctly configured.
...
curl http://<your-ec2-public-ip>:3000/stress

# custom duration in seconds (min 1, max 120)
curl "http://<your-ec2-public-ip>:3000/stress?seconds=30"
```

### Request parameters

- `seconds` (optional): how long to run the CPU stress task
  - default: `15`
